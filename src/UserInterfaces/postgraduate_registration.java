 ...
 * @author Ashera
 */
public class postgraduate_registration extends javax.swing.JFrame {

    /**
     * Creates new form postgraduate_registration
     */
    public postgraduate_registration() {
        initComponents();
    ...
    private void nextPageButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextPageButtonActionPerformed
        ...
        try{
            int result = postgraduateController.addStudent(stud1);
            if ( result>0 ) {
                facID = fac;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(postgraduate_registration.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
