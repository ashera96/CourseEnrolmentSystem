 ...
 * @author Ashera
 */
public class edit_postgraduate_education extends javax.swing.JFrame {

    /**
     * Creates new form edit_postgraduate_education
     */
    public edit_postgraduate_education() {
        initComponents();
        
        try {
            if(!isUndergraduate){
                String facultyID = postgraduateController.getPostgradStudentFaculty(editingStudentID);
                ArrayList<String> courseList = courseController.addPostgraduateCourses(facultyID);
    ...
    public void displayDetails() throws SQLException {
        try {
            postgraduate postgrad = postgraduateController.searchPostgraduate(editingStudentID);
            if(postgrad!=null) {
                qualificationType.setText(postgrad.getQualification_type());
                institute.setText(postgrad.getInstitute());
                year.setText(Integer.toString(postgrad.getYear_of_completion()));
                String followingCourse = courseController.findCourseName(postgrad.getCourse_id());
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        postgraduate postgrad = new postgraduate(editingStudentID,qualification_type, Institute, year_of_completion,course_id);
        try {
            int result = postgraduateController.updatePostgraduate(postgrad);
            if (result>0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_postgraduate_education.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
